  ...
  public function save()
{
    ...
    // =============================================================
    // 3) СОЗДАЁМ ВАЛИДАТОР + КАСТОМНАЯ ПРОВЕРКА ITEMS
    // =============================================================
    ...
    // =============================================================
    // 4) ЕСЛИ ЕСТЬ ОШИБКИ — ПЕРЕДАЁМ ИХ В LIVEWIRE И ВЫХОДИМ
    // =============================================================
    if ($validator->fails()) {
    ...
    // =============================================================
    // ДОП. ПРОВЕРКА: unloading после loading
    // =============================================================
