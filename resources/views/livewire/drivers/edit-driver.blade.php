...
<div class="p-4 sm:p-6 max-w-5xl mx-auto space-y-6 bg-gray-50 min-h-screen">
    ...
    <form wire:submit.prevent="save"
        ...
        {{-- Заголовок --}}
        <header>
            <h2 class="text-2xl sm:text-3xl font-bold mb-1 text-gray-900">✏️ Edit Driver</h2>
            <p class="text-gray-600 text-sm sm:text-base">Update driver details and save changes.</p>
        </header>
