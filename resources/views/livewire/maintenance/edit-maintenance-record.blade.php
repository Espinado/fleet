<div class="min-h-screen bg-gray-100 pb-24">
    <div class="max-w-2xl mx-auto px-4 py-6">
        <h1 class="text-xl sm:text-2xl font-semibold text-gray-800 mb-6">
            {{ __('app.maintenance_record.edit_title') }}
        </h1>

        <div class="rounded-lg bg-gray-50 border border-gray-200 px-4 py-3 mb-6">
            <p class="text-sm font-medium text-gray-700">{{ $record->vehicle_name }}</p>
            <p class="text-xs text-gray-500">{{ $record->vehicle_type === 'truck' ? __('app.nav.trucks') : __('app.nav.trailers') }}</p>
        </div>
        ...
        <form wire:submit="save" class="space-y-6 rounded-xl bg-white border border-gray-200 shadow-sm p-6">
            ...
            <div>
                ...
                <textarea id="description" wire:model="description" rows="4"
                          class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 min-h-[44px]"></textarea>
