                                    ...
                                    <div class="space-y-2">
                                        ...
                                        @empty
                                            <div class="text-[11px] text-gray-400">
                                                Сначала добавьте шаги маршрута.
                                            </div>
                                        @endforelse
                                    </div>
