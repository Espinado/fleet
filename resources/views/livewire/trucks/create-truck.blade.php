<div class="p-4 sm:p-6 max-w-5xl mx-auto space-y-6 bg-gray-50 min-h-screen">
    ...
    <form wire:submit.prevent="save"
        ...
        {{-- ========================================================= --}}
{{-- 1️⃣5️⃣ LICENSE (Truck driving license / registration) --}}
{{-- ========================================================= --}}
<section class="space-y-4">
    ...
    <div class="grid sm:grid-cols-3 gap-4">
        ...
        <div class="sm:col-span-1">
            ...
            <p class="text-xs text-gray-500 mt-1">Optional. Registration / license document number.</p>
        </div>
    ...
    <div class="text-sm text-gray-600 bg-gray-50 border rounded-xl p-3">
        <div class="flex items-start gap-2">
            ...
            <div>
                If you fill in dates, make sure <span class="font-medium">Expired</span> is after <span class="font-medium">Issued</span>.
